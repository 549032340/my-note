...
- 不要局限于当前互联网中微前端的实现效果，要去理解微前端的思想，当前的微前端框架只是其中的一直实现思路，微前端的代码不值钱，有价值的是微前端的思想理念
- 如何应用微前端思想
  - 项目级别：各个厂商的项目可以融合在同一个框架里
  - 代码级别：实现我们每个人写的代码互不影响，降低每个人之间代码的耦合度，通过框架将大家的代码耦合在一起，框架集成大家的公共部分的代码，实现框架的bug量降低，大家的bug就在减少

- 这次讲座也不必要准备的特别完善，可以是抛出来一个问题，然后大家一起探讨
- 开发者大会：自我介绍+你对微前端的理解+你关于微前端的
